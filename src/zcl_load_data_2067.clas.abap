CLASS zcl_load_data_2067 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_load_data_2067 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

      DATA: lt_acc_categ_2067 TYPE TABLE OF ztb_ac_cate_2067,
            lt_catego_2067    TYPE TABLE OF ztb_catego_2067,
            lt_clientes_2067  TYPE TABLE OF ztb_cliente_2067,
            lt_clnts_lib_2067 TYPE TABLE OF ztb_cln_lib_2067,
            lt_libros_2067    TYPE TABLE OF ztb_libros_2067.

    "Carga de Datos lt_acc_categ_2067
    lt_acc_categ_2067 = VALUE #(
    ...
    "Borrar Todo; insertar Todo
    DELETE FROM ztb_ac_cate_2067.
    INSERT ztb_ac_cate_2067 FROM TABLE @lt_acc_categ_2067.

        "Cargga de Datos lt_catego_2067
    lt_catego_2067 = VALUE #(
    ...
    DELETE FROM ztb_catego_2067.
    INSERT ztb_catego_2067 FROM TABLE @lt_catego_2067.

        "Carga de Datos lt_clientes
        lt_clientes_2067 = VALUE #(
     ...
     DELETE FROM ztb_cliente_2067.
     INSERT ztb_cliente_2067 FROM TABLE @lt_clientes_2067.

       "Carga de Datos lt_clnts_lib_2067
        lt_clnts_lib_2067 = VALUE #(
     ...
     DELETE FROM ztb_cln_lib_2067.
     INSERT ztb_cln_lib_2067 FROM TABLE @lt_clnts_lib_2067.

       "Carga Datos lt_libros
        lt_libros_2067 = VALUE #(
      ...
      DELETE FROM ztb_libros_2067.
      INSERT ztb_libros_2067 FROM TABLE @lt_libros_2067.
